...
const getUserIdFromToken = (token) => {
  try {
    const decoded = jwt.verify(token, process.env.JWT_SECRET); // Assuming you have a JWT secret
...
export async function POST(req, { params }) {
  // Ensure params are awaited before destructuring
  const { id: albumId } = await params; // Await params before accessing id
